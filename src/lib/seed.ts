import { MAX_DIAS_VIGENCIA, ZONAS_CAMPUS, puntoBase } from './constants'
import type {
  AnalyticsEvent,
  Database,
  Feria,
...
const puntoCerca = (tipo: TipoLugar, r: () => number) => {
  const base = puntoBase(tipo)
  // Dentro del campus el radio es chico; fuera se dispersa por la ciudad.
  const radio = tipo === 'campus' ? 0.004 : 0.02
  return { lat: base.lat + (r() - 0.5) * radio, lng: base.lng + (r() - 0.5) * radio }
}
...
export const USUARIOS: User[] = [
  ...
  { id: 'u-1', nombre: 'Matías Pizarro', correo: 'matias.pizarro@alumnos.ucn.cl', carrera: 'Ingeniería en Computación e Informática', role: 'estudiante', avatar: '#eb6834' },
  { id: 'u-2', nombre: 'Constanza Álvarez', correo: 'constanza.alvarez@alumnos.ucn.cl', carrera: 'Ingeniería Civil Ambiental', role: 'estudiante', avatar: '#1baf7a' },
  { id: 'u-3', nombre: 'Ignacio Tapia', correo: 'ignacio.tapia@alumnos.ucn.cl', carrera: 'Ingeniería Civil de Minas', role: 'estudiante', avatar: '#4a3aa7' },
  { id: 'u-4', nombre: 'Fernanda Muñoz', correo: 'fernanda.munoz@alumnos.ucn.cl', carrera: 'Psicología', role: 'estudiante', avatar: '#e87ba4' },
  { id: 'u-5', nombre: 'Diego Cortés', correo: 'diego.cortes@alumnos.ucn.cl', carrera: 'Derecho', role: 'estudiante', avatar: '#eda100' },
  { id: 'u-6', nombre: 'Camila Araya', correo: 'camila.araya@alumnos.ucn.cl', carrera: 'Arquitectura', role: 'estudiante', avatar: '#e34948' },
  { id: 'u-7', nombre: 'Sebastián Núñez', correo: 'sebastian.nunez@alumnos.ucn.cl', carrera: 'Ingeniería Comercial', role: 'estudiante', avatar: '#199e70' },
  { id: 'u-8', nombre: 'Valentina Soto', correo: 'valentina.soto@alumnos.ucn.cl', carrera: 'Enfermería', role: 'estudiante', avatar: '#3987e5' },
]
...
const SEMILLAS: SemillaPost[] = [
  // ── Trabajos ────────────────────────────────────────────────────────────
  {
    ...
    lugar: 'campus', zona: 'Biblioteca central', referencia: 'Sala de estudio del segundo piso',
  ...
  },
  {
    ...
    lugar: 'campus', zona: 'Edificio Y', hace: 26, vistas: 288, clics: 41,
  },
  {
    ...
    lugar: 'fuera', zona: 'A coordinar por mensaje', hace: 5, vistas: 734, clics: 158,
  },
  {
    ...
    lugar: 'campus', zona: 'Casino', hace: 40, vistas: 521, clics: 88,
  },
  {
    id: 'p-5', type: 'trabajo', titulo: 'Clases de natación para principiantes — piscina municipal',
    descripcion:
      'Soy monitora certificada y hago clases particulares de natación para principiantes y nivel intermedio. También preparo para el test de salvavidas.\n\nHorarios de mañana en la piscina municipal. La entrada la paga cada quien por su cuenta.',
    precio: 12000, precioNota: 'por clase', categoria: 'Clases particulares', autorId: 'u-2',
    lugar: 'campus', zona: 'Gimnasio', hace: 62, vistas: 196, clics: 24,
  },
  ...
  // ── Ventas ──────────────────────────────────────────────────────────────
  {
    ...
    lugar: 'campus', zona: 'Entrada principal', hace: 3, vistas: 640, clics: 112,
  },
  {
    ...
    lugar: 'campus', zona: 'Biblioteca central', hace: 14, vistas: 302, clics: 47,
  },
  {
    id: 'p-8', type: 'venta', titulo: 'Bicicleta aro 29 — perfecta para venir al campus',
    descripcion:
      'Bicicleta de montaña aro 29, 21 cambios, frenos de disco delanteros. La usé un año para moverme entre la casa y el campus. Le acabo de poner cámaras nuevas.\n\nIncluye candado en U y luz trasera. Se prueba antes de cualquier trato, sin problema.',
    precio: 130000, categoria: 'Bicicletas y movilidad', estadoArticulo: 'usado', autorId: 'u-6',
    lugar: 'campus', zona: 'Estacionamiento', hace: 30, vistas: 887, clics: 174,
  },
  {
  ...
  },
  {
    ...
    lugar: 'fuera', zona: 'A coordinar por mensaje', hace: 20, vistas: 431, clics: 96,
  },
  ...
  // ── Foro: ¿se perdió esto? ──────────────────────────────────────────────
  {
    ...
    lugar: 'campus', zona: 'Casino', hace: 18, vistas: 512, clics: 34,
    respuestas: [
  ...
  },
  {
    ...
    descripcion:
      'Se me cayeron entre el Edificio Y y la biblioteca, el martes en la tarde. Son tres llaves en un llavero de ballena azul tejido.\n\nSi alguien las vio, aviso por acá o déjenlas en portería. Es el único juego que tengo 😭',
    categoria: 'Llaves', autorId: 'u-2',
    lugar: 'campus', zona: 'Biblioteca central', hace: 33, vistas: 289, clics: 21,
    respuestas: [
  ...
  },
  {
    ...
    lugar: 'campus', zona: 'Edificio Y', hace: 70, vistas: 377, clics: 52,
    respuestas: [
  ...
  },
  {
    ...
    titulo: 'Se perdió el gato naranjo que anda por el campus',
    descripcion:
      'El "Michi del campus" que vive acá no aparece hace tres días. Es naranjo, con una oreja mordida, muy sociable.\n\nLos que le damos comida estamos preocupados. Si lo ven, avisen por acá. No lo saquen del campus, es su territorio.',
    categoria: 'Mascotas en el campus', autorId: 'u-6',
    lugar: 'campus', zona: 'Casino', hace: 44, vistas: 1204, clics: 67,
    respuestas: [
      { autor: 'Sebastián Núñez', carrera: 'Ingeniería Comercial', mensaje: 'Lo vi ayer detrás del Edificio Y, estaba bien. Le dejé comida.', hace: 20 },
  ...
  // ── En cola de moderación ───────────────────────────────────────────────
  {
    ...
    lugar: 'campus', zona: 'Entrada principal', hace: 2, vistas: 0, clics: 0,
  },
  {
    ...
    lugar: 'fuera', zona: 'A coordinar por mensaje', hace: 1, vistas: 0, clics: 0,
  },
  {
    ...
    lugar: 'fuera', zona: 'Terminal de buses', hace: 4, vistas: 0, clics: 0,
  },
  {
    ...
    lugar: 'campus', zona: 'Entrada principal', hace: 96, vistas: 0, clics: 0,
  },
  ...
  // ── Ya expirados / archivados (alimentan estadística histórica) ─────────
  {
    ...
    lugar: 'campus', zona: 'Casino', hace: 170, vistas: 703, clics: 131,
  },
  {
    ...
    lugar: 'fuera', zona: 'Mall Plaza Antofagasta', hace: 200, vistas: 559, clics: 143,
  },
]
...
const construirHistoricos = (r: () => number): Post[] =>
  PLANTILLAS_HISTORICAS.map((t, i) => {
    ...
    return {
      ...
      imagenes: [],
      ubicacion: {
        tipo: 'campus' as const,
        zona: ZONAS_CAMPUS[Math.floor(r() * ZONAS_CAMPUS.length)],
        punto: puntoCerca('campus', r),
      },
      contacto: {
        nombre: autor.nombre,
        carrera: autor.carrera,
...
const EMPRENDIMIENTOS_SEED: Omit<Emprendimiento, 'stats' | 'creadoEn' | 'suscripcionHasta' | 'suscripcionStatus'>[] = [
  ...
  },
  {
    ...
    carrera: 'Arquitectura', instagram: 'estudiomarea',
  ...
  },
  {
    ...
    carrera: 'Ingeniería Civil Ambiental', instagram: 'tejidos.atacama',
  ...
  },
  {
    ...
    descripcion: 'Carrito de café de especialidad que se instala en el campus de lunes a jueves. Grano de origen, leches vegetales disponibles.',
    rubro: 'Comida y repostería', logo: '#eda100', duenoId: 'u-3', dueno: 'Ignacio Tapia',
    carrera: 'Ingeniería Civil de Minas', instagram: 'cafesismico',
  ...
  },
  {
    ...
    carrera: 'Psicología', instagram: 'unasporfer',
    plan: 'vitrina', status: 'aprobado',
  },
  {
    ...
    carrera: 'Ingeniería Comercial', instagram: 'preunorte.paes',
  ...
  },
  {
    ...
    carrera: 'Derecho', instagram: 'segundavuelta.cl',
